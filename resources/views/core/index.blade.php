...
@section('content')
    <div class="w-full flex flex-col gap-6">
        <div class="flex flex-col gap-2">
            ...
            <ul class="grid grid-rows-1 grid-cols-2 lg:grid-cols-4 gap-6">
                <li
                    ...
                    <div class="flex flex-1 flex-col items-center lg:items-end">
                        ...
                        <p class="text-base lg:text-base text-gray-800">{{ Core::format($total) }}</p>
                    </div>
                </li>
                <li
                    class="bg-x-white rounded-x-huge shadow-x-core p-4 lg:p-6 flex gap-2 flex-col items-center lg:flex-row lg:flex-wrap">
                    ...
                    <div class="flex flex-1 flex-col items-center lg:items-end">
                        ...
                        <p class="text-base lg:text-base text-gray-800">{{ ($products < 9 ? '0' : '') . $products }}</p>
                    </div>
                </li>
                <li
                    class="bg-x-white rounded-x-huge shadow-x-core p-4 lg:p-6 flex gap-2 flex-col items-center lg:flex-row lg:flex-wrap">
                    ...
                    <div class="flex flex-1 flex-col items-center lg:items-end">
                        ...
                        <p class="text-base lg:text-base text-gray-800">{{ ($quotations < 9 ? '0' : '') . $quotations }}</p>
                    </div>
                </li>
                <li
                    class="bg-x-white rounded-x-huge shadow-x-core p-4 lg:p-6 flex gap-2 flex-col items-center lg:flex-row lg:flex-wrap">
                    ...
                    <div class="flex flex-1 flex-col items-center lg:items-end">
                        ...
                        <p class="text-base lg:text-base text-gray-800">{{ ($requests < 9 ? '0' : '') . $requests }}</p>
                    </div>
                </li>
            </ul>
        </div>
        <div class="flex flex-col gap-2">
            <div class="flex items-center justify-between">
                <h1 class="text-xl lg:text-2xl text-x-black font-x-thin">
                    {{ __('Possible Income Of The Week') }}
                </h1>
            </div>
                        ...
                        <table class="w-max min-w-full">
                            <thead>
                                <tr>
                                    ...
                                    <td class="text-x-black text-sm font-x-thin py-2 px-4 text-center w-24">
                                        {{ __('Image') }}
                                    </td>
                                    <td class="text-x-black text-sm font-x-thin py-2 px-4 text-center w-20">
                                        {{ __('Reference') }}
                                    </td>
                                    <td class="text-x-black text-sm font-x-thin py-2 px-4">
                                        {{ __('Name') }}
                                    </td>
                                    <td class="text-x-black text-sm font-x-thin py-2 px-4 pe-6 text-center w-20">
                                        {{ __('Quantity') }}
                                    </td>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($sells as $row)
                                    <tr class="border-t border-t-x-shade">
                                        ...
                                        <td class="text-x-black text-base py-2 px-4 w-24">
                                            <img src="{{ $row->Product->Images[0]->Url }}"
                                                class="block w-16 aspect-square object-contain object-center rounded-x-thin bg-x-black bg-opacity-10" />
                                        </td>
                                        <td class="text-x-black text-base py-2 px-4 text-center w-20">
                                            {{ $row->Product->reference }}
                                        </td>
                                        <td class="text-x-black text-base py-2 px-4">
                                            {{ $row->Product->name }}
                                        </td>
                                        <td class="text-x-black text-base py-2 px-4 pe-6 text-center w-20">
                                            {{ $row->sells }}
                                        </td>
                                    </tr>
                                @endforeach
        ...
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    borderWidth: 1,
                    backgroundColor: "rgb(2 201 59)",
                    borderColor: "rgb(2 201 59)",
                }]
            },
            options: {
                responsive: true,
