...
@section('content')
    <div class="flex flex-col gap-2">
            ...
            <div class="w-max ms-auto flex flex-wrap">
                ...
                <os-dropdown label="Columns" position="{{ Core::lang('ar') ? 'start' : 'end' }}" class="W160 sharp">
                    ...
                    <ul class="w-full flex flex-col p-4 gap-2">
                        ...
                        <li class="w-full">
                            <label class="flex flex-wrap gap-2 items-center">
                                <input checked data-type="column" data-for="first_name" type="checkbox"
                                    class="w-4 h-4 rounded-x-thin checked:accent-x-prime outline-2 outline-x-prime -outline-offset-2 focus:outline focus-within:outline">
                                <span class="text-base text-x-black">
                                    {{ __('First Name') }}
                                </span>
                        ...
                        <li class="w-full">
                            <label class="flex flex-wrap gap-2 items-center">
                                <input checked data-type="column" data-for="last_name" type="checkbox"
                                    class="w-4 h-4 rounded-x-thin checked:accent-x-prime outline-2 outline-x-prime -outline-offset-2 focus:outline focus-within:outline">
                                <span class="text-base text-x-black">
                                    {{ __('Last Name') }}
                                </span>
                        ...
                        <li class="w-full">
                            <label class="flex flex-wrap gap-2 items-center">
                                <input data-type="column" data-for="gender" type="checkbox"
                                    class="w-4 h-4 rounded-x-thin checked:accent-x-prime outline-2 outline-x-prime -outline-offset-2 focus:outline focus-within:outline">
                                <span class="text-base text-x-black">
                                    {{ __('Gender') }}
                                </span>
                        ...
                        <li class="w-full">
                            <label class="flex flex-wrap gap-2 items-center">
                                <input data-type="column" data-for="birth_date" type="checkbox"
                                    class="w-4 h-4 rounded-x-thin checked:accent-x-prime outline-2 outline-x-prime -outline-offset-2 focus:outline focus-within:outline">
                                <span class="text-base text-x-black">
                                    {{ __('Birth Date') }}
                                </span>
                        ...
                        <li class="w-full">
                            <label class="flex flex-wrap gap-2 items-center">
                                <input data-type="column" data-for="address" type="checkbox"
                                    class="w-4 h-4 rounded-x-thin checked:accent-x-prime outline-2 outline-x-prime -outline-offset-2 focus:outline focus-within:outline">
                                <span class="text-base text-x-black">
                                    {{ __('Address') }}
                                </span>
                ...
                <a title="{{ __('Create') }}" href="{{ route('views.users.store') }}"
                    class="block p-2 rounded-x-huge text-x-black outline-none !bg-opacity-10 hover:bg-x-black hover:text-x-prime focus:bg-x-black focus:text-x-prime focus-within:bg-x-black focus-within:text-x-prime">
                    <svg class="block w-6 h-6 pointer-events-none" fill="currentcolor" viewBox="0 -960 960 960">
                        <path
        ...
        <div class="bg-x-white rounded-x-huge shadow-x-core">
            <form id="search" action="{{ route('views.users.index') }}" method="GET"
            ...
            <div class="scroll w-full overflow-auto">
                <table data-type="display" class="w-max min-w-full">
                    ...
                    <thead>
                        <tr>
                            <td data-is="id" class="text-x-black text-sm font-x-thin py-2 px-4 ps-6 text-center">
                                {{ __('Id') }}
                            </td>
                            <td data-is="first_name" class="text-x-black text-sm font-x-thin py-2 px-4">
                                {{ __('First Name') }}
                            </td>
                            <td data-is="last_name" class="text-x-black text-sm font-x-thin py-2 px-4">
                                {{ __('Last Name') }}
                            </td>
                            <td data-is="gender" class="text-x-black text-sm font-x-thin py-2 px-4">
                                {{ __('Gender') }}
                            </td>
                            <td data-is="birth_date" class="text-x-black text-sm font-x-thin py-2 px-4">
                                {{ __('Birth Date') }}
                            </td>
                            ...
                            <td data-is="address" class="text-x-black text-sm font-x-thin py-2 px-4">
                                {{ __('Address') }}
                            </td>
                            <td data-is="actions"
                    ...
                    <tbody>
                        @forelse ($data as $row)
                            <tr class="border-t border-t-x-shade">
                                ...
                                <td data-is="first_name" class="text-x-black text-base py-2 px-4">
                                    {{ $row->first_name }}
                                </td>
                                <td data-is="last_name" class="text-x-black text-base py-2 px-4">
                                    {{ $row->last_name }}
                                </td>
                                <td data-is="gender" class="text-x-black text-base py-2 px-4">
                                    {{ $row->gender ?? '_' }}
                                </td>
                                <td data-is="birth_date" class="text-x-black text-base py-2 px-4">
                                    {{ $row->birth_date ?? '_' }}
                                </td>
                                ...
                                <td data-is="address" class="text-x-black text-base py-2 px-4">
                                    {{ $row->address ?? '_' }}
                                </td>
