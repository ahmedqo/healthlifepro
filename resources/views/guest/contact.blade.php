    ...
    <div class="my-6 lg:my-10">
        ...
        <section id="info">
            <div class="container mx-auto p-4">
                <ul class="w-full gap-6 lg:gap-10 grid grid-rows-1 grid-cols-1 lg:grid-cols-2">
                    <li
                        class="flex flex-col p-4 lg:p-6 items-center justify-center gap-4 bg-x-white rounded-x-huge border border-x-black border-opacity-10">
                        <svg class="block h-10 w-10 lg:h-16 lg:w-16 pointer-events-none" fill="currentcolor"
                        ...
                        <div class="w-full flex flex-col">
                            <a href="{{ env('LINK_MAP') }}"
                                class="w-full text-x-black text-lg lg:text-2xl font-x-thin text-center">
                    ...
                    <li
                        class="flex flex-col lg:col-span-2 p-4 lg:p-6 items-center justify-center gap-4 bg-x-white rounded-x-huge border border-x-black border-opacity-10">
                        <svg class="block h-10 w-10 lg:h-16 lg:w-16 pointer-events-none" fill="currentcolor"
                            viewBox="0 0 48 48">
                            <path
