<aside class="w-full flex flex-col gap-2">
    <div id="filter"
        class="!flex justify-between items-center gap-4 bg-x-light lg:bg-transparent rounded-x-huge px-4 py-2 lg:p-0">
        <h4 class="text-x-black text-lg lg:text-xl font-x-huge">
            {{ __('Categories') }}
        </h4>
        <button os-toggle os-targets="#categories, #filter" os-properties="hidden, bg-x-light, px-4, py-2"
    ...
    <nav id="categories"
        class="!bg-transparent rounded-x-huge !p-4 hidden lg:block border-4 border-dashed border-x-black-blur">
